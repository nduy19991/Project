        ...
        <div className={Styles.mid_main}>
          ...
          <div className={Styles.mid_btn}>
            <button className={Styles.mid_btnwomen}>
              <a className={Styles.mid_link} href="https://www.asos.com/women/">
                WOMEN
              </a>
            </button>
            <button className={Styles.mid_btnwomen}>
              <a className={Styles.mid_link} href="https://www.asos.com/men/">
                MEN
              </a>
            </button>
          </div>
          ...
          <div className={Styles.widgets}>
            <button className={Styles.btn_widgets}>
              <HiOutlineUser className={Styles.icon_widgets} />
            </button>
            <button className={Styles.btn_widgets}>
              <AiOutlineHeart className={Styles.icon_widgets} />
            </button>
            <button className={Styles.btn_widgets}>
              <AiOutlineShopping className={Styles.icon_widgets} />
            </button>
          </div>
        </div>
      </div>
