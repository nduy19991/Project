    ...
    <div>
      ...
      <div className={Styles.mid_bar}>
        <div className={Styles.mid_main}>
          <Link className={Styles.mid_linklogo} to={'/men'}>
            <img
          ...
          <div className={Styles.mid_search}>
            <div className={Styles.mid_bginput}>
              <InputSearchCommon
                ...
                onSubmit={(text) => {
                  navigate(`${location?.pathname?.includes('/products/') ? location?.pathname : '/products/sale'}?search=${text}`)
                }}
              />
            </div>
          </div>
          <div className={Styles.mid_right_group}>
            ...
            <Link className={Styles.widgets} to="/saved">
            ...
            <Link className={Styles.widgets} to="/bag">
