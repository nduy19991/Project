...
import TitleTableCommon from "../../common/TitleTableCommon/TitleTableCommon";
      ...
      <div className={Styles.mid_bar}>
        <div className={Styles.mid_main}>
          ...
          <div className={Styles.mid_btn}>
            ...
            >
              <a className={Styles.mid_link} href="http://localhost:3000/women">
                WOMEN
              </a>
            </button>
            <button
            ...
            >
              <a className={Styles.mid_link} href="http://localhost:3000/men">
                MEN
              </a>
            </button>
          </div>
                  ...
                  <div className={Styles.table_container}>
                    ...
                    <div className={Styles.table_bot}>
                      <ul style={{ padding: "0px", margin: "10px" }}>
                        ...
                        <TitleTableCommon title="My Account" />
                      </ul>
                    </div>
                  </div>
                </div>
